...
res2 = WS.sendRequest(findTestObject('Add defect', [('title') : 'Title', ('desc') : 'Desc', ('assignee') : 1, ('severity') : 'Normal'
            , ('priority') : 'Highest', ('env') : 'Production', ('step') : '1. Do nothing', ('cookie') : GlobalVariable.cookie]))
...
WS.verifyEqual(redirectUrl, '/project/2/defect')
