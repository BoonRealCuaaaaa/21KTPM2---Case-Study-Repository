...
res2 = WS.sendRequest(findTestObject('Add test case', [('cookie') : GlobalVariable.cookie, ('title') : 'Title', ('status') : 'Actual'
            , ('priority') : 'High', ('severity') : 'Normal', ('desc') : 'Description', ('suite') : -1, ('preCondition') : 'Precondition'
            , ('post') : 'Postcondition', ('step') : '1. Do nothing', ('expected') : 'Do nothing', ('projectId') : 2]))
...
WS.verifyEqual(redirectUrl, '/project/2/repository')
