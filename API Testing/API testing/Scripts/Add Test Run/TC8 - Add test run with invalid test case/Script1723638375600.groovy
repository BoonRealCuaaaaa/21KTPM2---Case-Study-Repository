...
res2 = WS.sendRequest(findTestObject('Add Test Run', [('cookie') : GlobalVariable.cookie, ('testcases') : ['9999999999'], ('title') : 'Title'
...
WS.verifyEqual(responseText, 'Invalid test case')
