...
res2 = WS.sendRequest(findTestObject('Add Test Run', [('cookie') : GlobalVariable.cookie, ('testcases') : ['207'], ('title') : ''
            , ('desc') : 'Desc', ('env') : 'not-set', ('tag') : 'Manual', ('type') : 'Manual']))

WS.verifyResponseStatusCode(res2, 402)

def responseText = res2.getResponseText()

WS.verifyEqual(responseText, 'Missing title')
