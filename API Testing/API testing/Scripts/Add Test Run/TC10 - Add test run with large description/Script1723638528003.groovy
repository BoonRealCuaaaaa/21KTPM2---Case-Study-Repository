...
res2 = WS.sendRequest(findTestObject('Add Test Run', [('cookie') : GlobalVariable.cookie, ('testcases') : ['207'], ('title') : 'Title'
            , ('desc') : GlobalVariable.char256, ('env') : 'not-set', ('tag') : 'Manual', ('type') : 'Manual']))

WS.verifyResponseStatusCode(res2, 400)

def responseText = res2.getResponseText()

WS.verifyEqual(responseText, 'Description exceed length')
